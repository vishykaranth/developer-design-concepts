package com.baeldung.moneywords;

import static org.junit.Assert.assertEquals;

import com.baeldung.numberwordconverter.NumberWordConverter;
...
public class NumberWordConverterUnitTest {
    ...
    public void whenMoneyNegative_thenReturnInvalidInput() {
        Assert.assertEquals(NumberWordConverter.INVALID_INPUT_GIVEN, NumberWordConverter.getMoneyIntoWords(-13));
    }
