...
public class UserData extends Person {
	...
	public String toString() {
		return "UserData(id=" + this.getId() + ", username=" + this.getUsername() + ", firstName=" + this.getFirstName() + ", lastName=" + this.getLastName() + ", email=" + this.getEmail() + ", lastUpdated=" + this.getLastUpdated() + ", active=" + this.isActive() + ")";
	}
